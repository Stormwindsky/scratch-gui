...
const messages = defineMessages({
    defaultTitle: {
        defaultMessage: 'Lightning Fast Scratch',
        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    description="Disclaimer that TurboWarp & StormWarp is not connected to Scratch & also we don't affiliated with the Turbowarp Team"
            ...
            <div className={styles.footerColumns}>
                ...
                <div className={styles.footerSection}>
                    <a href="https://gamejolt.com/c/Stormwindsky-yk7ybk/stormwarp_feedback">
                        <FormattedMessage
                    ...
                    <a href="https://github.com/Stormwindsky/List-of-repository-linked-with-StormWarp">
                        <FormattedMessage
                    ...
                    <a href="https://github.com/TurboWarp/">
                        <FormattedMessage
                            defaultMessage="Source Code of Turbowarp"
                            description="Link to source code of Turbowarp"
                            id="tw.code"
                        />
                    </a>
                    <a href="privacy.html">
                            ...
                            <div className={styles.section}>
                                <p>
                                    <FormattedMessage
                                        ...
                                        description="Description of StormWarp on the homepage"
